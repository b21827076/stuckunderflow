...
import com.project.stuckunderflow.requests.RefreshRequest;
import com.project.stuckunderflow.requests.UserRequest;
import com.project.stuckunderflow.responses.AuthResponse;
import com.project.stuckunderflow.security.JwtTokenProvider;
import com.project.stuckunderflow.services.RefreshTokenService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> register(@RequestBody UserRequest registerRequest){
        ...
        if(userService.getOneUserByUserName(registerRequest.getUserName()) != null){
            ...
            SecurityContextHolder.getContext().setAuthentication(auth);
            String jwtToken = jwtTokenProvider.generateJwtToken(auth);
            authResponse.setMessage("User sucessfully registered.");
            authResponse.setAccessToken("Bearer "+jwtToken);
    ...
    public ResponseEntity<AuthResponse> refresh(@RequestBody RefreshRequest refreshRequest){
        ...
        if(token.getToken().equals(refreshRequest.getRefreshToken()) && !refreshTokenService.isRefreshExpired(token)){
            ...
            response.setMessage("User sucessfully registered.");
